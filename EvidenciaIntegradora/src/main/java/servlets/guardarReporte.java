 ...
 * @author Emmanuel
 */
public class guardarReporte extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int prioridad, estadorep, asignatura, persona;
            ...
            int estatus = AccionesReporte.registrarReporte(e);
            
            if(estatus>0){
                response.sendRedirect("registroR.jsp");
            }else{
