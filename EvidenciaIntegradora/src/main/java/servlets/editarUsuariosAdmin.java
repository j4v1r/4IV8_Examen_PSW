 ...
 */
public class editarUsuariosAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int identificador, persona_id, grupo, rolp, rols;
            ...
            int estatus = AccionesUsuario.actualizarUsuarios(e);
            
            if(estatus>0){
                response.sendRedirect("editUsuarios.jsp?persona_id="+persona_id);
            }else{
